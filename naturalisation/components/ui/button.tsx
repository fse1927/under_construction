...
// Simplified version of shadcn-ui button without cva dependency for now to keep it minimal, 
// unless I want to install class-variance-authority. 
// Let's implement a robust simple version.
