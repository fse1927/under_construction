...
export default async function LearningDetailPage(props: PageProps) {
    ...
    return (
        <div className="p-4 pb-24 max-w-2xl mx-auto">
            <Link href="/apprendre" className="inline-flex items-center text-gray-500 hover:text-primary mb-6 transition-colors">
            ...
            >
                <article className="space-y-6 p-6">
                    <header className="space-y-4">
                        ...
                        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 leading-tight">{item.titre}</h1>
